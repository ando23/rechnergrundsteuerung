...
//void gfx_line(uint16_t x, uint16_t y, uint16_t nx, uint16_t ny, uint32_t col);
void gfx_rect(uint16_t x, uint16_t y, uint16_t w,uint16_t h, uint32_t col);

/*
void gfx_text(uint16_t x, uint16_t y, const char* str, uint32_t col, uint8_t fontNo);
*/
